...
```{r pcpscale, fig.cap="Interactively exploring the effect of scaling on a PCP. Changing the scale applied to the parallel axes reveals different aspects of the data. This interactive figure can be accessed at <https://shanl33.shinyapps.io/nceapcp/>.", out.width="700px"}
