...
The interactive techniques applied during the exploratory analysis allowed multiple views of the data to be explored simultaneously and thoroughly. 
...
The amount of effort and code required for implementing interactive techniques varies depending on the software used and generally more than one software package is required. The combination of **plotly**, **crosstalk** and **shiny** makes the software required for interactive data visualisation easily accessible to statisticians and provides a thorough coverage of the key interactive skills. The ease of sharing and documentation resulting from these code-based software are also 
These software make sharing the interactivity used in analysis easier and provides the documentation for the interactive techniques to be used again in future analysis.
Although Tukey's comments in 1965 were in response to the impact of computers on statistical practices at the time, his words are still relevant in the 21st Century. The introduction of the internet and the development of web-based graphics, have provided easy access to "powerful factories" for creating interactive visualisations. How do these visualisations benefit data analysis? Is there enough value added for it to be worthwhile learning, or teaching? This paper examines how interactive techniques have been applied in data analysis and demonstrates the practicalities of using current open-source, code-based software to implement interactive data visualisation.
